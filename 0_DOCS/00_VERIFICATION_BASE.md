...
Le script lit `1_MES_NOTEBOOKS/ipynb` (originaux), `3_SESSIONS_RATEES/ipynb` (gutés)
et `2_NOUVEAUX/ipynb` (refait). Ajuste la table `ALIAS` dans le script si un renommage
n'est pas reconnu.
