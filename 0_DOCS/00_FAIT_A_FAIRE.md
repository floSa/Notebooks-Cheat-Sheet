...
> `1_MES_NOTEBOOKS/`, jamais sur les gutés. Les 24 sujets neufs s'inspirent de `2_NOUVEAUX/`.
...
- 🆕 **à implémenter** : sujet neuf, pas d'original → partir du plan + inspiration 2_NOUVEAUX.
...
## D. Sujets NEUFS à implémenter (24 — depuis plan + inspiration 2_NOUVEAUX)
