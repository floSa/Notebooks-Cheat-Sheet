...
> **Incident 2026-06-01** : les vrais originaux (`1_MES_NOTEBOOKS/ipynb/`, source `data/Notebooks.zip`)
...
| Refait (2_NOUVEAUX/ipynb) | Vrai original | base utilisée | Statut |
|---|---:|---:|---|
...
(`1_MES_NOTEBOOKS/ipynb/<nom accentué>.ipynb`), pas la base gutée. La refonte existante
