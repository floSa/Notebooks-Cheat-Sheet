...
> **Incident 2026-06-01** : les vrais originaux (`Notebook_2018-2021/ipynb/`, source `data/Notebooks.zip`)
...
| Refait (Notebook_2026/ipynb) | Vrai original | base utilisée | Statut |
|---|---:|---:|---|
...
(`Notebook_2018-2021/ipynb/<nom accentué>.ipynb`), pas la base gutée. La refonte existante
