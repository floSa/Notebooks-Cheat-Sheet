...
- **Notebooks ✅ fait au sens du contrat (5 critères vérifiés)** : **8** — EDA_Visualisation_Introduction (#8), EDA_Analyse_Multivarie (#9), EDA_Stats_Analyse_Desc_Visual (#10), Detection_Outliers (#11), DL_KAN_Kolmogorov_Arnold (#26), BDD_Vectorielles (#40), DE_Docling (#43), DL_Keras (#46).
