...
Le script lit `1_Old_Notebooks/ipynb` (originaux), `3_Sessions_Ratees/ipynb` (gutés)
et `2_New_Notebooks/ipynb` (refait). Ajuste la table `ALIAS` dans le script si un renommage
n'est pas reconnu.
